...
public class BaseClassForSanityTest {
	...
	public void configBC() throws Throwable {
		...
		dc.setCapability(MobileCapabilityType.PLATFORM_VERSION,   eLib.getDataFromExcel("DesiredCapabilities", 3, 1));
		dc.setCapability(MobileCapabilityType.UDID,               eLib.getDataFromExcel("DesiredCapabilities", 4, 1));
